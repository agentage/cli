...
import { spawnDaemon, type SpawnOutcome } from '../../lib/daemon/daemon-client.js';
import { checkForUpdate, INSTALL_HINT, type UpdateInfo } from '../../lib/update/update-check.js';
