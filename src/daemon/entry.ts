...
// Boot the real daemon. Invoked by the bin (src/daemon-entry.ts) once the observability bootstrap
// has run; importing this module for tests must never start a server.
